...
public class NestedScrollingDetailContainer extends ViewGroup implements NestedScrollingParent2 {
    ...
    public static final String TAG_NESTED_SCROLL_SWIPEREFRESHLAYOUT = "nested_scroll_swiperefreshlayout";
    ...
    private boolean isTouchNestedInnerView(int x, int y) {
        ...
        if (mSwipeRefreshLayout != null) {
            innerView.add(mSwipeRefreshLayout);
        }
    ...
    private void findSwipeRefreshLayout(ViewGroup parent) {
        if (mSwipeRefreshLayout != null) {
            return;
        }
        ...
        for (int i = 0; i < count; i++) {
            ...
            if (child instanceof SwipeRefreshLayout && TAG_NESTED_SCROLL_SWIPEREFRESHLAYOUT.equals(child.getTag())) {
                mSwipeRefreshLayout = (SwipeRefreshLayout) child;
                break;
            }
            if (child instanceof ViewGroup) {
                findSwipeRefreshLayout((ViewGroup) child);
            }
        }
    }
